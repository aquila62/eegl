...
int main(void)
   ...
   while (i--)
      {
      int indx;
      indx = (eegl(ee) >> 28) & 15;      /* 4 bit sample 0-15 */
   ...
   while (i--)
      {
      int indx;
      indx = (eegl(ee) >> 24) & 15;      /* 4 bit sample 0-15 */
      tally[indx] += 1.0;        /* tally the sample */
      } /* for each sample */
   /******************************************/
   /* add up the chi square from 16 counters */
   ...
   while (i--)
      {
      int indx;
      indx = (eegl(ee) >> 20) & 15;      /* 4 bit sample 0-15 */
      tally[indx] += 1.0;        /* tally the sample */
      } /* for each sample */
   /******************************************/
   /* add up the chi square from 16 counters */
   ...
   while (i--)
      {
      int indx;
      indx = (eegl(ee) >> 16) & 15;      /* 4 bit sample 0-15 */
      tally[indx] += 1.0;        /* tally the sample */
      } /* for each sample */
   /******************************************/
   /* add up the chi square from 16 counters */
   ...
   while (i--)
      {
      int indx;
      indx = (eegl(ee) >> 12) & 15;      /* 4 bit sample 0-15 */
      tally[indx] += 1.0;        /* tally the sample */
      } /* for each sample */
   /******************************************/
   /* add up the chi square from 16 counters */
   ...
   while (i--)
      {
      int indx;
      indx = (eegl(ee) >> 8) & 15;      /* 4 bit sample 0-15 */
      tally[indx] += 1.0;        /* tally the sample */
      } /* for each sample */
   /******************************************/
   /* add up the chi square from 16 counters */
   ...
   while (i--)
      {
      int indx;
      indx = (eegl(ee) >> 4) & 15;      /* 4 bit sample 0-15 */
      tally[indx] += 1.0;        /* tally the sample */
      } /* for each sample */
   /******************************************/
   /* add up the chi square from 16 counters */
   ...
   while (i--)
      {
      int indx;
      indx = eegl(ee) & 15;      /* 4 bit sample 0-15 */
      tally[indx] += 1.0;        /* tally the sample */
      } /* for each sample */
   /******************************************/
   /* add up the chi square from 16 counters */
