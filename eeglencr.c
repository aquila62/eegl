/************************************************************************/
/* eeglencr.c  Version 1.0.0                                            */
/* Encrypt an input stream with the eegl algorithm                      */
...
/**********************************************************/
/* This program initializes the eegl random number        */
...
/* Once initialized with RANDU, eegl is warmed up         */
...
int main(int argc, char **argv)
   ...
   unsigned int *statep;       /* pointer into ee->state */
   unsigned int *stateq;       /* pointer for end of ee->state */
   unsigned char psw[128];     /* password text */
   unsigned char *buf;         /* input/output buffer */
   eefmt *ee;                  /* eegl RNG structure */
   ...
   ee->prev  = RANDU;
   ee->pprev = RANDU;
   statep = (unsigned int *) ee->state;
   stateq = (unsigned int *) ee->state + 1024;
   while (statep < stateq)
      {
      *statep++ = RANDU;
      } /* for each state in ee->state array */
   /*****************************************************/
   /* warm up the eegl random number generator          */
   /*****************************************************/
   i = 2048;
   while (i--) eegl(ee);
   /*****************************************************/
